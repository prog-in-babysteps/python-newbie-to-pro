...
plt.bar(months, chennai_temps, color='red', label='Chennai', linewidth=2)
plt.bar(months, madurai_temps, color='orange', label='Madurai', linewidth=2)
plt.bar(months, coimbatore_temps, color='green', label='Coimbatore', linewidth=2)
